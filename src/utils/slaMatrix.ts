...
export const SLA_ETA_SALIDA_MATRIX: SLAEtaSalidaRule[] = [
    {
        ...
        via: "AEREO",
        tipoCarga: "CARGA SUELTA",
        normal: { automatico: 1, documental: 2, fisico: 3 },
    ...
    },
    {
        ...
        via: "AEREO COURIER - CONSUMO",
        tipoCarga: "CARGA SUELTA",
        normal: { automatico: 0, documental: 1, fisico: 2 },
        prioridad: { automatico: 0, documental: 1, fisico: 1 },
    },
    {
        regimen: ["20", "21", "31"],
        via: "AEREO",
        tipoCarga: "CARGA SUELTA",
        normal: { automatico: -999, documental: 1, fisico: 2 },
        prioridad: { automatico: -999, documental: 1, fisico: 1 },
    },
    {
        regimen: ["10"],
        via: "MARITIMO",
    ...
    },
    {
        ...
        via: "TERRESTRE",
        tipoCarga: "CARGA SUELTA",
        normal: { automatico: -999, documental: 1, fisico: 1 },
        prioridad: { automatico: -999, documental: 1, fisico: 1 },
    },
];
